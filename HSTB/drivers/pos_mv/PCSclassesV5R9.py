...
class GNSS_receiver_channel_status_data(BaseField):
    ...
    sdf_list = [['2', 'ushort', 'SV PRN', '[1, 138] N/A ', 'SV PRN 2 ushort [1, 138] N/A '],
 ['2',
  'ushort',
...
class GNSS_navigation_solution_status(BaseField):
    FieldTag="GNSS_navigation_solution_status"
    sdf_list = []
    def __init__(self, *args, **opts):
        BaseField.__init__(self, *args, **opts)
...
structures['GNSS_navigation_solution_status']=GNSS_navigation_solution_status
structures["see table 9"]=GNSS_navigation_solution_status
...
class GAMS_Solution_Status(BaseField):
 ...
 ['2',
  'ushort',
  'Cycle slip flag',
  'Bits 0-11:  (k-1)th bit set to 1 implies cycle slip in channel k. ',
...
class General_and_FDIR_status(BaseField):
 ...
 ['4',
  'ulong',
  'Extended Status',
  'Primary GPS in Marinestar HP mode bit 0: set ',
...
class Auxiliary_1_2_GPS_status(BaseField):
 ...
 ['1',
  'byte',
  'Navigation solution status',
  'See Table 9 (See xTable 10 when using NAVCOM) N/A ',
...
structures["see table 20"]=Auxiliary_1_2_GPS_status
...
class IIN_solution_status(BaseField):
 ...
 ['2',
  'ushort',
  'L1 cycle slip flag',
  'Bits 0-11:  (k-1)th bit set to 1 implies L1 cycle slip in channel k PRN. Example: Bit 3 set to 1 implies an L1 cycle slip in channel 4. ',
 ...
 ['2',
  'ushort',
  'L2 cycle slip flag',
  'Bits 0-11:  (k-1)th bit set to 1 implies L2 cycle slip in channel k PRN. Example: Bit 3 set to 1 implies an L2 cycle slip in channel 4. ',
...
structures["see table 25"]=Base_GPS_1_2_Modem_Status
...
structures["see table 26"]=Auxiliary_1_2_GPS_raw_display_data
...
class GNSS_Receiver_MarineSTAR_Status(BaseField):
 ...
 ['1', 'byte', 'Satellite ID', '(0,100) ', 'Satellite ID 1 byte (0,100) '],
 ['4',
  'ulong',
 ...
 ['1',
  'byte',
  'MarineSTAR library active flag',
  '0  Not Active ',
  'MarineSTAR library active flag 1 byte 0  Not Active '],
 ['1',
  'byte',
  'Engine mode used by the library',
  '1  HP  ',
 ...
 ['4', 'byte', 'Reserved', 'Reserved N/A ', 'Reserved 4 byte Reserved N/A '],
 ['4', 'byte', 'Reserved', 'Reserved N/A ', 'Reserved 4 byte Reserved N/A '],
 ['1',
  'byte',
 ...
 ['1', 'byte', 'Reserved', ' Reserved N/A ', 'Reserved 1 byte  Reserved N/A '],
 ['1', 'byte', 'Reserved', ' Reserved N/A ', 'Reserved 1 byte  Reserved N/A '],
 ['1', 'byte', 'Reserved', ' Reserved N/A ', 'Reserved 1 byte  Reserved N/A '],
 ['1',
  'byte',
...
structures["see table 31"]=MV_General_Status_FDIR
...
class GAMS_installation_parameters(BaseField):
 ...
 ['2', 'ushort', 'Byte count', '  36 N/A ', 'Byte count 2 ushort   36 N/A '],
 ['2',
  'ushort',
  'Transaction number',
  'Input: Transaction number ',
...
class Set_POS_IP_Address(BaseField):
 ...
 ['1',
  'byte',
  'Network part 1',
  '[1, 126] Class A (typical subnet mask 255.0.0.0) ',
...
class Event_Discrete_Setup(BaseField):
 ...
 ['2', 'ushort', 'Byte count', '  28 N/A ', 'Byte count 2 ushort   28 N/A '],
 ['2',
  'ushort',
  'Transaction number',
  'Input:  Transaction number ',
...
class COM_Port_Setup(BaseField):
 ...
 ['2',
  'ushort',
  'Port mask',
  'Input: Bit positions indicate which port parameters are in message (port parameters must appear in order of increasing port number). Bit 0 ignored Bit n set COMn parameter in message Bit n clear COMn parameter not in message ',
...
class Base_GPS_1_2_Setup(BaseField):
 ...
 ['2', 'ushort', 'Byte count', ' 248 N/A ', 'Byte count 2 ushort  248 N/A '],
 ['2',
  'ushort',
  'Transaction number',
  'Input: Transaction number ',
 ...
 ['1', 'byte', 'Host part 1', ' [0, 255] ', 'Host part 1 1 byte  [0, 255] '],
 ['1', 'byte', 'Host part 2', ' [1, 254] ', 'Host part 2 1 byte  [1, 254] '],
 ['2',
  'ushort',
  'Port Number',
  ' (0,65535] ',
...
class Aux_GNSS_Setup(BaseField):
    ...
    sdf_list = [['4', 'char', 'Message start', '$MSG N/A ', 'Message start 4 char $MSG N/A '],
 ['2', 'ushort', 'Message ID', '39 N/A ', 'Message ID 2 ushort 39 N/A '],
...
class Primary_GPS_Receiver_Integrated_DGPS_Source_Control(BaseField):
    ...
    sdf_list = [['4', 'char', 'Message start', '$MSG N/A ', 'Message start 4 char $MSG N/A '],
 ['2', 'ushort', 'Message ID', '41 N/A ', 'Message ID 2 ushort 41 N/A '],
 ['2', 'ushort', 'Byte count', '  52 N/A ', 'Byte count 2 ushort   52 N/A '],
 ['2',
  'ushort',
  'Transaction number',
  'Input: Transaction number ',
 ...
 ['1',
  ...
  'Beacon mode used to acquire DGPS signals : ',
...
class Real_Time_Logging_Data_Port_Control(BaseField):
    ...
    sdf_list = [['4', 'char', 'Message start', '$MSG N/A ', 'Message start 4 char $MSG N/A '],
 ['2', 'ushort', 'Message ID', '52 N/A ', 'Message ID 2 ushort 52 N/A '],
 ['2',
  'ushort',
  'Byte count',
  '15 + 2 x number of groups ',
 ...
 ['1', 'byte', 'Network part 1', ' ', 'Network part 1 1 byte  '],
 ['1',
  'byte',
  'Network part 2',
...
class Logging_Port_Control(BaseField):
    ...
    sdf_list = [['4', 'char', 'Message start', '$MSG N/A ', 'Message start 4 char $MSG N/A '],
 ['2', 'ushort', 'Message ID', '53 N/A ', 'Message ID 2 ushort 53 N/A '],
 ['2',
  'ushort',
  'Byte count',
  '76 + 2 x number of groups ',
...
class Second_Data_Port_Control(BaseField):
    FieldTag="Second_Data_Port_Control"
    sdf_list = [['4', 'char', 'Message start', '$MSG N/A ', 'Message start 4 char $MSG N/A '],
 ['2',
  'ushort',
  'Message ID',
...
structures['Second_Data_Port_Control']=Second_Data_Port_Control
structures["see table 68"]=Second_Data_Port_Control
        
MESSAGE_ID_VALUES[52]='Second_Data_Port_Control'

MESSAGE_VALUE_IDS['Second_Data_Port_Control']=52

MESSAGE_ID_VALUES[61]='Second_Data_Port_Control'

MESSAGE_VALUE_IDS['Second_Data_Port_Control']=61
...
class Heave_Filter_Set_up(BaseField):
    ...
    sdf_list = [['4', 'char', 'Message start', '$MSG N/A ', 'Message start 4 char $MSG N/A '],
 ['2', 'ushort', 'Message ID', '106 N/A ', 'Message ID 2 ushort 106 N/A '],
 ['2', 'ushort', 'Byte count', '16 N/A ', 'Byte count 2 ushort 16 N/A '],
 ['2',
  'ushort',
  'Transaction',
...
class Password_Protection_Control(BaseField):
 ...
 ['20',
  'char',
  'Password',
  'String value of current Password, terminated by "null" if less than 20 characters, or 20 (non-null) characters. ',
...
structures["see table 80"]=Byte_Format
...
structures["see table 81"]=Short_Integer_Format
...
structures["see table 82"]=Long_Integer_Format
