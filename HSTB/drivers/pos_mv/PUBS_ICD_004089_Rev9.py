...
Document # : PUBS-ICD-004089 
Revision: 9 
Date: 22 February 2017 

Revision Level Description of Change Edited By: Date 
0 ECR- 03835 
Initial revision J. Li 14-Dec-10 
1 ECR- 03835 
Update msg41, msg135, Update grp10, Added grp29. 
Update grp 3, 11, 12, 13 week number max to 9999. J. Li 27-Mar-12 
2 ECR- 03835 
Update grp 12/13 for NavCom 2050 & 3050. J. Li 1-May-12 
Change msg20 time type 1 default value from GPS to UTC. J. Li 15-May-12 
Add new NMEA UTCT output format in msg135. J. Li 17-Aug-12 
3 Added G2 mode to group 3 and 10 D. Yen 25 Nov. 13 
4 Added Tate Bryant notes to Group 1, 102, 103 J. Chung 11, Feb. 14 Added DGPS Source 2 field  (message 41) I. Nedeljkovic 28, Apr. 14 
5 Added NMEA GGAT format to Msg 135 R. Beyeler 13-Apr-2015 
6 Updated maximum number of SV in groups 3, 11, 12 & 13. R. Beyeler 13-May-2015 
Added Lower NMEA Output Rate to Msg 135 R. Pan 04-Aug-2015 
New GAMS/GNSS heading implementation; updated changes to group 14, and message 21, 57, and 58. Removed unused bits in Group 10 FDIR Level 1. Removed unsupported bits for multipath in Message 20. D. Yen 19-Aug-2015 
Updated group 99 with new option field. R. Beyeler 7-Dec-2015 
7 Updated Message 41, Group 3, 10 and 29 E. Ren 11-Feb-2016 
Rearrange group 29 so new field is at the end 
Corrected Message 21 SD field range. D. Yen 03-Mar-2016 
Added message 33. R. Beyeler 16-Mar-2016 
8 Updated information for messages: 32, 52, and 61 to accompany the implementation of UDP unicast Danut Tabacaru 26-Jul-2016 

Updated information for messages 37 and 38 for RTK over Ethernet D. Yen 9-Sept-2016 Clarify Message 34 about port assignments D. Yen 17-Nov-2016 Added Message 39 and correct Table 42 D. Yen 17-Nov-2016 Clarify Message 34, 38, 52 D. Yen 25-Nov-2016 Removed table 56 because of redundancy D. Yen 25-Nov-2016 
9 Fixed minor mistakes in Message 41 and Group 14. D. Tabacaru 2-Feb-2017 Fixed more mistakes in Message 41 D. Yen 22-Feb-17 
...
3.3.1 POS Data Groups .................................................................................................................... 8 
Group 1: Vessel Position, Velocity, Attitude & Dynamics ................................................................ 8 
Group 2: Vessel Navigation Performance Metrics .......................................................................... 10 
Group 3: Primary GNSS Status........................................................................................................ 11 
Group 4: Time-tagged IMU Data ..................................................................................................... 14 
Group 5: Event 1 .............................................................................................................................. 15 
Group 6: Event 2 .............................................................................................................................. 15 
Group 7: PPS Time Recovery and Status ........................................................................................ 15 
Group 8: Logging Parameters and Status ......................................................................................... 16 
Group 9: GAMS Solution ................................................................................................................ 17 
Group 10: General Status and FDIR ................................................................................................ 19 
Group 11: Secondary GNSS Status .................................................................................................. 24 
Group 12: Auxiliary 1 GPS Status ................................................................................................... 25 
Group 13: Auxiliary 2 GPS Status ................................................................................................... 26 
Group 14: Calibrated Installation Parameters .................................................................................. 27 
Group 17: User Time Status ............................................................................................................. 29 
Group 20: IIN Solution Status .......................................................................................................... 29 
Group 21: Base GPS 1 Modem Status ............................................................................................. 31 
Group 22: Base GPS 2 Modem Status ............................................................................................. 31 
Group 23: Auxiliary 1 GPS Display Data ........................................................................................ 31 
Group 24: Auxiliary 2 GPS Display Data ........................................................................................ 32 
Group 29: GNSS Receiver MarineSTAR Status.............................................................................. 32 
Group 99: Versions and Statistics .................................................................................................... 35 
Group 102: Sensor 1 Position, Velocity, Attitude, Heave & Dynamics .......................................... 36 

Group 103: Sensor 2 Position, Velocity, Attitude, Heave & Dynamics .......................................... 36 
Group 104: Sensor 1 Position, Velocity, and Attitude Performance Metrics .................................. 38 
Group 105: Sensor 2 Position, Velocity, and Attitude Performance Metrics .................................. 38 
Group 110: MV General Status & FDIR ......................................................................................... 39 
Group 111: Heave & True Heave Data ............................................................................................ 39 
Group 112: NMEA Strings .............................................................................................................. 40 
Group 113: Heave & True Heave Performance Metrics .................................................................. 41 
Group 114: TrueZ & TrueTide Data ................................................................................................ 41 
3.3.2 Raw Data Groups .................................................................................................................. 42 
Group 10001: Primary GPS Data Stream ........................................................................................ 42 
Group 10002: Raw IMU Data .......................................................................................................... 43 
Group 10003: Raw PPS ................................................................................................................... 44 
Group 10007: Auxiliary 1 GPS Data Stream ................................................................................... 44 
Group 10008: Auxiliary 2 GPS Data Stream ................................................................................... 44 
Group 10009: Secondary GPS Data Stream .................................................................................... 45 
Group 10011: Base GPS 1 Data Stream .......................................................................................... 46 
Group 10012: Base GPS 2 Data Stream .......................................................................................... 46 
4 MESSAGE INPUT AND OUTPUT ................................................................................................... 47 
4.1 Introduction .................................................................................................................................. 47 
...
4.4.1 General Messages .................................................................................................................. 51 
Message 0: Acknowledge ................................................................................................................ 51 
4.4.2 Installation Parameter Set-up Messages ................................................................................ 53 
Message 20: General Installation and Processing Parameters ......................................................... 53 
Message 21: GAMS Installation Parameters ................................................................................... 58 
Message 24: User Accuracy Specifications ..................................................................................... 60 
Message 30: Primary GPS Setup ..................................................................................................... 60 
Message 31: Secondary GPS Setup ................................................................................................. 63 
Message 32: Set POS IP Address ..................................................................................................... 64 
Message 33: Event Discrete Setup ................................................................................................... 67 
Message 34: COM Port Setup .......................................................................................................... 69 
Message 35: See Message 135 ......................................................................................................... 72 
Message 36: See Message 136 ......................................................................................................... 72 

Message 37: Base GPS 1 Setup ....................................................................................................... 72 
Message 38: Base GPS 2 Setup ....................................................................................................... 72 
Message 39: Aux GNSS Setup ........................................................................................................ 74 
Message 41: Primary GPS Receiver Integrated DGPS Source Control ........................................... 75 
4.4.3 Processing Control Messages ................................................................................................ 77 
Message 50: Navigation Mode Control ........................................................................................... 77 
Message 51: Display Port Control ................................................................................................... 78 
Message 52: Real-Time Data Port Control ...................................................................................... 79 
Message 53: Logging Port Control .................................................................................................. 81 
Message 54: Save/Restore Parameters Control ................................................................................ 83 
Message 55: User Time Recovery ................................................................................................... 84 
Message 56: General Data ............................................................................................................... 84 
Message 57: Installation Calibration Control................................................................................... 86 
Message 58: GAMS Calibration Control ......................................................................................... 88 
Message 61: Logging Data Port Control .......................................................................................... 89 
4.4.4 Program Control Override Messages .................................................................................... 90 
Message 90: Program Control .......................................................................................................... 90 
Message 91: GPS Control ................................................................................................................ 91 
4.4.5 POS MV Specific Messages ................................................................................................. 92 
Message 106: Heave Filter Set-up ................................................................................................... 92 
Message 111: Password Protection Control ..................................................................................... 93 
Message 120: Sensor Parameter Set-up ........................................................................................... 94 
Message 121: Vessel Installation Parameter Set-up ........................................................................ 96 
Message 135: NMEA Output Set-up ............................................................................................... 97 
Message 136: Binary Output Set-up ................................................................................................ 99 
4.4.6 POS MV Specific Diagnostic Control Messages ................................................................ 102 
Message 20102: Binary Output Diagnostics .................................................................................. 102 
...
Table 2: Group format .................................................................................................................................. 5 
Table 3: Time and distance fields ................................................................................................................. 6 
Table 4: Group 1: Vessel position, velocity, attitude & dynamics ............................................................... 9 
Table 5: Group 1 alignment status .............................................................................................................. 10 
Table 6: Group 2: Vessel navigation performance metrics ......................................................................... 10 
Table 7: Group 3: Primary GNSS status ..................................................................................................... 11 
Table 8: GNSS receiver channel status data ............................................................................................... 12 
Table 9: GNSS navigation solution status .................................................................................................. 13 
Table 10: NAVCOM navigation solution status ......................................................................................... 13 
Table 11: GNSS channel status ................................................................................................................... 14 
Table 12: GNSS receiver type .................................................................................................................... 14 
Table 13: Group 4: Time-tagged IMU data ................................................................................................ 15 
Table 14: Group 5/6: Event 1/2 .................................................................................................................. 15 
Table 15: Group 7: PPS Time Recovery and Status ................................................................................... 16 
Table 16: Group 8: Logging Information ................................................................................................... 17 
Table 17: Group 9: GAMS Solution Status ................................................................................................ 18 
Table 18: Group 10: General and FDIR status ........................................................................................... 19 
Table 19: Group 11: Secondary GNSS status ............................................................................................. 24 
Table 20: Group 12/13: Auxiliary 1/2 GPS status ...................................................................................... 26 
Table 21: Group 14: Calibrated installation parameters ............................................................................. 27 
Table 22: IIN Calibration Status ................................................................................................................. 28 
Table 23: Group 17: User Time Status ....................................................................................................... 29 
Table 24: Group 20: IIN solution status ...................................................................................................... 30 
Table 25: Group 21/22: Base GPS 1/2 Modem Status ................................................................................ 31 
Table 26: Group 23/24: Auxiliary 1/2 GPS raw display data ..................................................................... 32 
Table 27: Group 29: GNSS Receiver MarineSTAR Status ........................................................................ 32 
Table 28: Group 99: Versions and statistics ............................................................................................... 35 
Table 29: Group 102/103: Sensor 1/2 Position, Velocity, Attitude, Heave & Dynamics ........................... 37 
Table 30: Group 104/105: Sensor 1/2 Position, Velocity, and Attitude Performance Metrics ................... 38 
Table 31: Group 110: MV General Status & FDIR .................................................................................... 39 
Table 32: Group 111: Heave & True Heave Data....................................................................................... 39 
Table 33: Group 112: NMEA Strings ......................................................................................................... 40 
Table 34: Group 113: Heave & True Heave Performance Metrics............................................................. 41 
Table 35: Group 114: TrueZ & TrueTide Data ........................................................................................... 42 

Table 36: Group 10001: Primary GPS data stream ..................................................................................... 42 
Table 37: Group 10002: Raw IMU data ..................................................................................................... 43 
Table 38: Group 10003: Raw PPS .............................................................................................................. 44 
Table 39: Group 10007/10008: Auxiliary 1/2 GPS data streams ............................................................... 44 
Table 40: Group 10009: Secondary GPS data stream ................................................................................. 45 
Table 41: Group 10011/10012: Base GPS 1/2 data stream ......................................................................... 46 
Table 42: Control messages output data rates ............................................................................................. 48 
Table 43: Message format ........................................................................................................................... 50 
Table 44: Message 0: Acknowledge ........................................................................................................... 52 
Table 45: Message response codes ............................................................................................................. 52 
Table 46: Message 20: General Installation and Processing Parameters .................................................... 56 
Table 47: Message 21: GAMS installation parameters ............................................................................... 59 
Table 48: Message 24: User accuracy specifications .................................................................................. 60 
Table 49: Message 30: Primary GPS Setup ................................................................................................ 61 
Table 50: RS-232/422 communication protocol settings ............................................................................ 62 
Table 51: Message 31: Secondary GPS Setup ............................................................................................ 63 
Table 52: Message 32: Set POS IP Address ............................................................................................... 65 
Table 53: Message 33: Event Discrete Setup .............................................................................................. 68 
Table 54: Message 34: COM Port Setup .................................................................................................... 70 
Table 55: COM port parameters ................................................................................................................. 71 
Table 56: Message 37/38: Base GPS 1/2 Setup .......................................................................................... 73 
Table 57: Message 39: Aux GNSS Setup ................................................................................................... 74 
Table 58: Message 41: Primary GPS Receiver Integrated DGPS Source Control ..................................... 75 
Table 59: Message 50: Navigation mode control ....................................................................................... 77 
Table 60: Message 51: Display Port Control .............................................................................................. 78 
Table 61: Message 52 Real-Time/Logging Data Port Control ................................................................... 80 
Table 62: Message 53: Logging Port Control ............................................................................................. 82 
Table 63: Message 54: Save/restore parameters control ............................................................................. 83 
Table 64: Message 55: User time recovery ................................................................................................. 84 
Table 65: Message 56: General data ........................................................................................................... 85 
Table 66: Message 57: Installation calibration control ............................................................................... 87 
Table 67: Message 58: GAMS Calibration Control .................................................................................... 88 
Table 68: Message 61: Second Data Port Control ...................................................................................... 89 
Table 69: Message 90: Program Control .................................................................................................... 90 
Table 70: Message 91: GPS control ............................................................................................................ 91 
Table 71: Message 106: Heave Filter Set-up .............................................................................................. 92 
Table 72: Message 111: Password Protection Control ............................................................................... 93 
Table 73: Message 120: Sensor Parameter Set-up ...................................................................................... 95 
Table 74: Message 121: Vessel Installation Parameter Set-up ................................................................... 96 

Table 75: Message 135: NMEA Output Set-up .......................................................................................... 97 
Table 76: NMEA Port Definition................................................................................................................ 98 
Table 77: Message 136: Binary Output Set-up ........................................................................................... 99 
Table 78: Binary Port Definition .............................................................................................................. 100 
Table 79: Message 20102: Binary Output Diagnostics ............................................................................. 103 
Table 80: Byte Format .............................................................................................................................. 104 
Table 81: Short Integer Format ................................................................................................................. 104 
Table 82: Long Integer Format ................................................................................................................. 104 
Table 83: Single-Precision Real Format ................................................................................................... 104 
Table 84: Double-Precision Real Format .................................................................................................. 105 
Table 85: Invalid data values .................................................................................................................... 106 
"""
...
This document describes the data structures that are implemented in the V5 system version of POS MV. POS MV V5 shall hereafter be refered to as POS MV or simply POS. 
2 Ethernet and Data Acquisition Interfaces 
The POS MV provides a mechanism for control and data exchange in the form of control messages and data groups. Control messages direct POS MV to execute a well-defined action such as mode transition, or start or stop of data acquisition. Data groups contain the data output by the POS MV for the purpose of display on a control computer, recording to a mass storage device, or for real-time processing by another subsystem. POS MV exchanges all control messages with a user via the POS's Control Port. It outputs all data groups on the Display and Data Logging Ports. 
Applanix provides a program called MV POSView with the POS MV to run on the user's PC-compatible computer running Microsoft Windows XP/Vista/7. The user's PC is called the client computer and is used to both control the system and allow the user to view POS data via the control messages and data groups specified in this document. The user can create custom control and display software that implements similar functionality. In either case, the program that provides the control and display functions on the client computer will hereafter be referred to as the POS Controller. 
POS MV provides one physical Ethernet interface that has four logical communications ports called the Display Port, the Control Port, the Real-Time Data Port and the Logging Data Port.  
POS MV outputs data in specified group formats defined in the body of this document. Messages are used to both change and describe the system configuration. Both message and group data are output on three ports: Display, Real-Time Data and Logging Data. Messages are input on the Control Port. 
...
The port address for the Real-Time Data Port is 5602 and 5603 for the Logging Data Port. The IP subnet mask is 255.255.255.255. 
The user is able to select, from several different options, the data required for output. Each port can be configured to output different data than the other ports. POS MV accepts changes to the output options of the Display, Data and Logging ports at any time. MV POSView automatically sends the Display Port control message to output the data groups that it requires to populate the display windows as the user opens them. 
The Control Port is designed to receive set-up and control commands from the POS Controller and to acknowledge the commands to indicate successful reception of each message. The Control Port is bi-directional and uses the TCP/IP protocol to communicate with the POS Controller. 
...
All POS products use the following group numbering convention. POS MV outputs the group categories shown. Reserved group numbers are assigned to other products. 
...
10200 - 19999 Reserved 
20000 POS Core User diagnostic group 
20001 - 20099 Reserved 
20100 POS MV User diagnostic group 
Core User data groups and MV User data groups comprise groups that contain real-time operational data. During normal operation, these are the only groups that a user would require for observing or recording relevant POS MV data. 
Core Raw data groups and POS MV Raw data groups comprise the unaltered data streams from the navigation sensors received by the PCS. POS MV packages the sensor data into the specified group formats and outputs the groups. These groups are typically used for post-mission processing and analysis. 
...
1 These groups are the minimum output of the Display Port for driving the POS View display and cannot be deselected. 
2 Groups are only posted when data were available. 
3 Maximum output rate for WaveMaster is 100 Hz 
3.2.3 Group Format 
...
The group identification or Group ID is a short unsigned integer equal to the group number having the group numbering convention described in Section 3.2.2. 
The byte count is a short unsigned integer that includes all fields in the group except the $GRP delimiter, the Group ID and the byte count. Therefore, the byte count is always 8 bytes less than the length of the group. 
...
Time 1 is the POS MV system time of validity of the data in the group, given in one of the following time bases: 
...
Time 2 is the POS MV system time of validity of the data in the group, given in one of the following time bases: 
. POS time (time in seconds since power-on) 
...
User time is specified by the user, with the procedure to set user time described in the POS MV User Guide. It allows the groups to be time tagged with an external computer's time clock. The Time 2 field is always set to POS time for the raw (10000) series of data groups. 
Distance tag is the distance of validity of the data in the group as determined by one of the following distance measurement sources: 
. distance traveled derived from the POS MV blended navigation solution 

. DMI (distance measurement index) distance tag 


The group data follows the header. Its format is dependent on the particular group. Some group data lengths are fixed, whereas others may vary. For variable length groups the byte count is always updated to reflect the actual length of the group. 
...
The ranges of valid values for group fields that contain numbers are specified using the following notation. 
[a, b] implies the range a to b including the range lower and upper boundaries. A value x that falls in this range will respect the inequality a . x . b. 
(a, b) implies the range a to b excluding the range lower and upper boundaries. A value x that falls in this range will respect the inequality a . x . b. 
(a, b] implies the range a to b excluding the lower boundary and including the upper boundary. A value x that falls in this range will respect the inequality a . x . b. 
[a, b) implies the range a to b excluding the range lower and upper boundaries. A value x that falls in this range will respect the inequality a . x . b. 
...
This group contains vessel position, velocity and attitude performance metrics. The data in this group is valid for the position defined by the user-entered reference vessel lever arms. 
...
Item Bytes Format Value Units 
GPS/UTC week number 4 ulong [0, 9999) 
0 if not available week 
...
SV PRN is encoded as follows: 
GPS: 1 - 37  
GLONASS: 52 - 75, offset 51 
BeiDou: 76 - 105, offset 75 
SBAS: 120 - 138  

Table 9: GNSS navigation solution status 
...
Time/Distance Fields   26 See Table 3 
IMU Data 29 byte IMU data- export controlled 
Pad 1 byte 0 N/A 
Checksum 2 ushort N/A N/A 
Group end 2 char $# N/A 
...
The time and distance fields in this group indicate the time and distance of the PPS from the primary GPS receiver. The PPS count is the number of PPS messages since power-up and 
initialization of the GPS receivers. The time synchronization status field indicates the status of POS MV synchronization to the PPS time provided by the primary GPS receiver as follows: 
No synchronization indicates that the POS MV has not synchronized to GPS time. This is the case if the GPS receiver has not initialized and provided time recovery data to the POS MV. 
...
Fully synchronized indicates that the POS MV has established synchronization to GPS time with less than 10 microseconds error and is maintaining the synchronization once per second. 
Using old offset indicates that the POS MV is using the last good clock offset to compute GPS times. The POS MV has either not received a PPS or time recovery message or has rejected erroneous GPS time synchronization data. 
...
Logging State 1 byte 0 Standby 
...
Cycle slip flag 2 ushort Bits 0-11:  (k-1)th bit set to 1 implies cycle slip in channel k. 
Example: Bit 3 set to 1 implies cycle slip in channel 4. 
Bits 12-15: not used. 
...
General Status A contains bit-encoded status information from the following processes: integrated navigation, data logging and generic hardware. 
General Status B contains bit-encoded status information from the following processes: primary GPS data input, secondary GPS data input, auxiliary GPS data input, GAMS. 
General Status C contains bit-encoded information from the following processes: integrated navigation, gimbal data input, DMI data input, base GPS messages (RTCM, CMR, RTCA) input. 
FDIR Level 1, similar to a built-in test, reports problems in communications between the sensors and the PCS. 
...
FDIR Level 3, Reserved. 
FDIR Level 4, the residual test, monitors the measurement residuals from the Kalman filter and rejects measurements that fall outside a specified 95% confidence level. Consistent measurement rejection indicates a potential IMU or aiding sensor failure. 
...
Item Bytes Format Value Units Degraded navigation solution bit 6: set 
...
Item Bytes Format Value Units Primary GPS in C/A mode bit 18: set 
...
Secondary GPS observables in use bit 24: set   Auxiliary GPS navigation solution in use bit 25: set 
...
IIN in narrow lane RTK aided mode bit 17: set   Received RTCM Type 1 message  bit 18: set 
Received RTCM Type 3 message  bit 19: set 
Received RTCM Type 9 message  bit 20: set 

Item Bytes Format Value Units Received RTCM Type 18 messages  bit 21: set 
...
Primary ephemeris data gap bit 11: set   Primary GPS missing ephemeris bit 13: set 
...
Reserved bits: 4, 12 14-19, 22-24, 27-29 
...
Item Bytes Format Value Units Reserved bits: 4-15 
...
Item Bytes Format Value Units 
Extended Status 4 ulong Primary GPS in Marinestar HP mode bit 0: set 
Primary GPS in Marinestar XP mode bit 1: set 
Primary GPS in Marinestar VBS mode bit 2: set 
Primary GPS in PPP mode bit 3: set 
Aux. GPS in Marinestar HP mode bit 4: set 
Aux. GPS in Marinestar XP mode bit 5: set 
Aux. GPS in Marinestar VBS mode bit 6: set 
Aux. GPS in PPP mode bit 7: set 
Primary GPS in Marinestar G2 mode bit 12:set 
Primary GPS in Marinestar HPXP mode bit 14:set 
Primary GPS in Marinestar HPG2 mode bit 15:set 
Reserved bits: 8-11  13,16-31 
Pad 0 byte 0 N/A 
Checksum 2 ushort N/A N/A 
Group end 2 char $# N/A 
...
This group contains data from an optional auxiliary 2 external GPS receiver. The group has the same format as Group 12. Table 20 specifies the format for both Groups 12 and 13 
Table 20: Group 12/13: Auxiliary 1/2 GPS status 
Item Bytes Format Value Units 
Group start 4 char $GRP N/A 
Group ID 2 ushort 12 or 13 N/A 
Byte count 2 ushort   72 + 20 x (number of channels) Bytes 
Time/Distance Fields   26 See Table 3 
Navigation solution status 1 byte See Table 9 (See xTable 10 when using NAVCOM) N/A 
Number of SV Tracked 1 byte [0, 60] N/A 
Channel status byte count 2 ushort [0, 1200] Bytes 
Channel status  variable See Table 8 
HDOP 4 float (0, ) N/A 
...
Time/Distance Fields   26 See Table 3 
Calibration status 2 ushort See the Table 22 bit-field 
...
Primary to Secondary GPS lever arm 
calibration FOM 2 ushort [0, 100] N/A 
Pad 0 byte 0 N/A 
Checksum 2 ushort N/A N/A 
Group end 2 char $# N/A 
...
This group contains the IIN observables processing status and relevant data. The following are descriptions of some of the fields. 
The number of satellites field gives the number of satellites in the IIN solution. The a priori PDOP is the PDOP of the satellite constellation selected by IIN before processing. The baseline length is the computed distance between the primary GPS antenna and the reference GPS 
...
IIN processing status 2 ushort 0 Fixed Narrow Lane RTK 
1 Fixed Wide Lane RTK 
2 Float RTK 
3 Code DGPS 
4 RTCM DGPS 
5 Autonomous (C/A) 
6 GPS navigation solution 
7 No solution 
PRN assignment 12 12 byte Each byte contains 0-40 where 
0  = unassigned PRN 
1-40  = PRN assigned to channel 
L1 cycle slip flag 2 ushort Bits 0-11:  (k-1)th bit set to 1 implies L1 cycle slip in channel k PRN. Example: Bit 3 set to 1 implies an L1 cycle slip in channel 4. 
Bits 12-15: not used. 
L2 cycle slip flag 2 ushort Bits 0-11:  (k-1)th bit set to 1 implies L2 cycle slip in channel k PRN. Example: Bit 3 set to 1 implies an L2 cycle slip in channel 4. 
Bits 12-15: not used. 
Pad 2 byte 0 N/A 
...
The base GPS process may receive differential corrections from a base station via a modem connected to one of the POS MV serial ports. This group contains status information about the modem connected to the serial port associated with the Base GPS 1 input. 
Group 22: Base GPS 2 Modem Status 
This group contains status information about the modem connected to the serial port associated with the Base GPS 2 input. 
Table 25: Group 21/22: Base GPS 1/2 Modem Status 
Item Bytes Format Value Units 
Group start 4 char $GRP N/A 
...
Table 26: Group 23/24: Auxiliary 1/2 GPS raw display data 
Item Bytes Format Value Units 
Group start 4 char $GRP N/A 
...
Item Bytes Format Value Units 
MarineSTAR Status 1 byte 0  MarineSTAR off  
1-2 Test Mode 
3-4 Searching Mode 
5  Tracking Initialization 
6  Verifying Data Stream 
7  Fully Tracking Satellite 
4-255 Reserved N/A 
Satellite ID 1 byte (0,100) 
Special ID 
100 Custom satellite                          110 Automatically choose satellite N/A 
Frequency of the satellite 4 ulong Satellite Frequency Hz 
Bit Rate of the satellite 2 ushort Data transfer rate  bit/sec 
HP/XP -  
MarineSTAR library active flag 1 byte 0  Not Active 
1  Active N/A 
HP/XP - 
Engine mode used by the library 1 byte 1  HP  
2  XP 
3  G2 
4  HP+G2  
5  HP+XP N/A 
HP/XP Subscription starting date - year 2 ushort 0 for no valid subscription N/A 
Subscription starting date - month 1 byte 1-12  
or 0 for no valid subscription N/A 
Subscription starting date - day 1 byte 1-31  
or 0 for no valid subscription N/A 

Item Bytes Format Value Units 
HP/XP Subscription expiration date - year 2 ushort 0 for no valid subscription N/A 
Subscription expiration date - month 1 byte 1-12  
or 0 for no valid subscription N/A 
Subscription expiration date - day 1 byte 1-31  
or 0 for no valid subscription N/A 
Subscribed engine mode 1 byte 1  HP  
2  XP 
3  G2 
4  HP+G2  
5  HP+XP N/A 
...
Reserved 4 byte Reserved N/A 
HP/XP status -  
Receiver Operation Mode 1 byte 1  Static  
2  kinematic  N/A 
HP/XP status -MarineSTAR Operation Mode 1 byte 0   Kinematic  


1  Static 
2  MarineSTAR not ready N/A 
...
IMU type, 
Primary GPS type (Table 12), 
Secondary GPS type (Table 12), 
DMI type, 
Gimbal type, 
ZVI type, 
IMU housing type 
..... 
Example: 
MV-320,VER5,S/N5050,HW1.05-10, 
SW06.00-Jan3/11,ICD04.10, 
OS6.4.1,IMU7,PGPS16,SGPS16, 
DMI0,GIM0,ZVI0,IHT101 
...
Item Bytes Format Value Units . Release date 
...
Options 80 Char [option mnemonic-expiry time] 
...
1 Heave is output in the gravity direction from a local level frame located at the sensor 1 or 2 position. The Heave sign is positive down. 
Group 104: Sensor 1 Position, Velocity, and Attitude Performance Metrics 
This group contains sensor 1 position, velocity and attitude performance metrics. All data in this group are RMS values. 
Group 105: Sensor 2 Position, Velocity, and Attitude Performance Metrics 
This group contains sensor 2 position, velocity and attitude performance metrics. All data in this group are RMS values. 
...
Table 31: Group 110: MV General Status & FDIR 
Item Bytes Format Value Units 
Group start 4 char $GRP N/A 
Group ID 2 ushort 110 N/A 
Byte count 2 ushort 36 Bytes 
Time/Distance Fields   26 See Table 3 
General Status 2 ushort User logged in bit 0: set 
reserved bit 1 to 9 
TrueZ Active bit 10: set 
TrueZ Ready bit 11: set 
TrueZ In Use bit 12: set 
Reserved bit 13 to 15 
...
Group 10003: Raw PPS 
This group contains the raw PPS data that the POS MV generates. The time of the PPS is given in the Time/Distance fields. 
Table 38: Group 10003: Raw PPS 
Item Bytes Format Value Units 
Group start 4 Char $GRP N/A 
Group ID 2 Ushort 10003 N/A 
Byte count 2 Ushort 36 Bytes 
Time/Distance Fields 26 See Table 3 N/A  
...
The byte count is a short unsigned integer that includes the number of bytes in all fields in the message except the Message start ASCII delimiter, the Message ID and the byte count. Therefore, the byte count is always 8 bytes less than the length of the complete message. 
...
The pad is used to make each message length a multiple of four bytes. The checksum is calculated so that short (16 bit) integer addition of sequential groups of two bytes results in a net sum of zero. 
Parameters flagged as default are the factory settings. 
The byte, short, ushort, long, ulong, float and double formats are defined in Appendix A: Data Format Description. 
The ranges of valid values for message fields that contain numbers are specified in the same way as for numerical group fields. 
Message fields that contain numerical values may contain invalid numbers. Invalid byte, short, ushort, long, ulong, float and double values are defined in Table 85 (Appendix A: Data Format Description). POS MV ignores invalid values that it receives in fields containing numerical values. This does not apply to fields containing bit settings. 
4.4 Messages Tables 
...
parameters to non-volatile memory if the user has not already done so before commanding a Standby mode transition or system shutdown. 
POS MV sets the Parameter Name to the name of a parameter that it has rejected or to a null string if it did not reject any parameters. 
...
2 Message accepted - 
too long POS MV has accepted the messaged from the POS Controller. This is a warning that the POS MV expected a shorter message than the one received. This could be caused if the POS MV and the POS Controller have different ICD versions. 

Field Value Field Name Description 
3 Message accepted - 
too short POS MV has accepted the messaged from the POS Controller. This is a warning that the POS MV expected a longer message than the one received. This could be caused if the POS MV and the POS Controller have different ICD versions. 
...
Time Tag Selection 
The Time Tag Type field selects the time tag types used for Time 1, Time 2 and Distance fields in the Time/Distance fields in each group (see Table 3). The user can select POS, GPS or UTC time for Time 1 and POS, GPS, UTC or User time for Time 2. 
Selection of GPS time directs POS MV to set the selected Time 1 or Time 2 field in all groups to the GPS seconds of the current week. The GPS week number can be obtained from Group 3: Primary GNSS status. 
...
The reference frame is a user-defined coordinate frame that is co-aligned with the Vessel frame, but which may be at a location that allows easier measurement of lever arms. It is also the coordinate frame in which the relative positions and orientations of the IMU and aiding sensors are measured. Its origin does not necessarily coincide with the Vessel frame origin, however it is aligned with the Vessel frame. 
...
Item Bytes Format Value Units 0 Low (default) 
...
This message sets the user accuracy specifications for full navigation status. POS MV declares Full Navigation status on the front panel LED's and through the POS Controller when the position, velocity, attitude and heading error RMS have all dropped to or below these accuracy specifications. 
...
The Primary GPS COM2 Port Control directs the primary GPS receiver to accept RTCM differential corrections, RTCA Type 18/19 corrections, CMR corrections or commands over its 
COM2 port. This message assumes that the user can access the GPS receiver COM2 port directly and connect either a source of RTCM differential corrections or a PC-compatible computer running control software that is compatible with the primary GPS receiver. The POS MV  hardware connects the GPS 1 port on the PCS back panel directly to the Primary GPS COM2 port. The Primary GPS COM2 port must not be confused with the COM2 port on the PCS. POS MV processes raw GPS observables and corrections so there is no need to feed corrections directly to the Primary GPS receiver. The GPS 1 port on the PCS read panel is primarily to allow GPS receiver firmware upgrades. 
Note: GPS Autoconfig will be turned off upon receipt of an Accept Command message and will be turned on again when either an Accept RTCM or a GPS reconfigure message is issued. 
The Primary GPS COM2 Communication Protocol fields are elaborated in Table 50. They specify the COM2 RS-232 communication protocol settings. 
...
Output: [65533, 65535] N/A 
Select/deselect 
GPS AutoConfig 1 byte Value State  
...
2-255 Reserved 
Primary GPS COM1 port message output rate(not supported) 1 byte Value  Rate (Hz) 
1  1 (default) 
2  2 
3  3 
4  4 
...
Item Bytes Format Value Units 
Primary GPS COM2 
communication protocol 4 See Table 50 
Default: 9600 baud, no parity, 8 data bits, 
1 stop bit, none 
Antenna frequency (only applicable for Trimble Force5 GPS receivers) 1 byte Value  Operation 
0  Accept L1 only 
1  Accept L1/L2 
2  Accept L2 only 
Pad 2 byte 0 N/A 
...
Item Bytes Format Value 
Flow Control1 1 byte Value  Flow Control 
0  none 
1  hardware 
2  XON/XOFF 
3-255  Reserved 
...
1 AutoConfig enabled (default) 
2-255 Reserved 
Secondary GPS COM1 port message output rate (Not Supported) 1 byte Value Rate (Hz) 
1 1 (default) 
2 2 
3 3 
4 4 
...
This message installs a new IP address and subnet mask in POS MV. POS MV accepts this message at anytime. The parameters contained in this message become part of the processing parameters (referred to as "settings"), however, POS MV does not save it to NVM but changes 
an OS setup file. 
It is important to note that while POS provides a lot of freedom to choose addresses, the Internet Assigned Numbers Authority (IANA) has reserved only the following three blocks of the IP address space for private internets: 10.0.0.0 - 10.255.255.255  172.16.0.0 - 172.31.255.255  192.168.0.0 - 192.168.255.255 
...
Output: [65533, 65535] N/A 
IP address: 
Network part 1 1 byte [1, 126] Class A (typical subnet mask 255.0.0.0) 
[128, 191] Class B (typical subnet mask 255.255.0.0 
[192, 223] Class C (typical subnet mask 255.255.255.0)  default = 129 N/A 
IP address: 
Network part 2 1 byte  [0, 255] default = 100 N/A 
IP address: 
Host part 1 1 byte  [0, 255] default = 0 N/A 
IP address: 
Host part 2 1 byte  [1, 254] default = 219 N/A 
Subnet mask: 
Network part 1 1 byte  [255] default = 255 * see conditions below  

Item Bytes Format Value Units 
Subnet mask: 
Network part 2 1 byte  [0, 255] default = 255 
* see conditions below  
Subnet mask: 
Host part 1 1 byte  [0, 255] default = 0 
* see conditions below  
Subnet mask: 
Host part 2 1 byte  [0, 254] default = 0 
* see conditions below  
Pad 2 byte 0 N/A 
Checksum 2 ushort N/A N/A 
Message end 2 char $# N/A 
...
POS IP:                             172           16             30            100                                      10101100 00010000 00011110 01100100 
SUBNET:                          255          255             0              0                                      11111111 11111111 00000000 00000000 
UDP IP:                             192          168             53             1                                      11000000 10101000 00110101 00000001 
POS IP & SUBNET:   10101100 00010000 00000000 00000000 
UDP IP & SUBNET:   11000000 10101000 00000000 00000000 
Note that (POS IP & SUBNET) != (UDP IP & SUBNET) Once modified, the POS IP will change to 172.168.30.100 but the real-time output port will not be sending data to 192.168.53.1 (the selected UDP unicast IP) because it is not on the same subnet. 
...
The Guard Time instructs POS MV to ignore any additional event triggers that occur on that input for the specified amount of time after the initial trigger. This can be useful for filtering out spurious trigger signals. The maximum event input frequency is 500 Hz so the default guard time 
is 2 ms. 
...
1   Negative edge 
2-255   Reserved 
Event 3 trigger 1 byte Value  Command 
0   Positive edge (default) 
1   Negative edge 
2-255   Reserved 
Event 4 trigger 1 byte Value  Command 
0   Positive edge (default) 
1   Negative edge 
2-255   Reserved 
Event 5 trigger 1 byte Value  Command 
0   Positive edge (default) 
1   Negative edge 
2-255   Reserved 

Item Bytes Format Value Units 
Event 6 trigger 1 byte Value  Command 
0   Positive edge (default) 
1   Negative edge 
2-255   Reserved 
...
PPS Out polarity 1 byte Value  Command 
0   Positive pulse (default) 
1   Negative pulse 
2   Pass through1 
3-255   Reserved 
...
1 - "Pass though" means the PPS Out pulse is identical to the PPS In pulse, whether it is from the internal GNSS or an external PPS source. If this mode is selected the PPS Out pulse width field is ignored. 
...
When this message is sent to POS MV it may contain parameters for 1 to 10 COM ports. Any COM port can be assigned. If an assigned COM port is not present it will be ignored. Any COM port or ports can be specified as long as they are listed in ascending order and the Port Mask field has bits set corresponding to each COM port entry. All input selections and the Base GNSS output selections must be uniquely assigned to a COM port. NMEA and Real-time Binary outputs may be assigned to any number of COM ports. COM6 and 10 are currently considered to be reserved as there is no physical hardware support. COM5 is only provided on certain supporting systems. Please refer to hardware specification for COM5 inclusion. As of FW9.xx, 
COM7 is used to confirm availability of input through Ethernet, while COM8 and 9 are used to confirm availability of output through Ethernet. COM7 (Ethernet Input) is available across all products. Thus, it should be always included in the Message 34. COM8 and 9 (Ethernet Output) is only available on certain MV configurations. Those configurations should include COM8 and 9 in their Message 34. Note: if COM7, 8, 9 were not part of the user-sent Message 34 but they exist, then the echo reply will contain them. 
...
COM Port Parameters 8 x nPorts See  
Table 55 
One set of parameters for each of nPorts COM port. 

Item Bytes Format Value Units 
Port mask 2 ushort Input: Bit positions indicate which port parameters are in message (port parameters must appear in order of increasing port number). Bit 0 ignored Bit n set COMn parameter in message Bit n clear COMn parameter not in message 
Output: Bit positions indicate which port numbers are available on the PCS for I/O configuration. 
Pad 2 byte 0 N/A 
Checksum 2 ushort N/A N/A 
Message end 2 char $# N/A 
...
This message selects the message types assigned to the Base GPS 1 port identified in Message 34. If POS MV is connected to a Hayes compatible telephone modem, then this message directs POS MV's configuration of the modem.  
Message 38: Base GPS 2 Setup 
This message selects the message types assigned to the Base GPS 2 port identified in Message 34. If POS MV is connected to a Hayes compatible telephone modem, then this message directs POS MV's configuration of the modem. 
The connection control field will always be set to NO_ACTION when sent by POS MV except when the message sent by the client had modem control set to AUTOMATIC and the connection control set to CONNECT. The reason for this is to prevent manual or command actions from getting saved in NVM and being inadvertently activated when POS MV is started. The AUTOMATIC-CONNECT combination is the only one that a user may want to save to NVM. 
...
Output: [65533, 65535] N/A 
Select Base GPS 
input type 2 ushort Value Operation     
0 Do not accept base GPS messages 
1 Accept RTCM MSG 1/9 (default) 
2 Accept RTCMv2.x MSG 3, 18/19 
3 Accept CMR/CMR+ 
4 Accept RTCA (Deprecated) 
5 Accept RTCMv3.x 
6-65535 Reserved 
...
Datum Type 2 ushort Value Operation 
0  WGS 84 (default) 
1 NAD 83 
Communication Protocol 1 byte Value Protocol 
0  COM (default) 
1 TCP 
2  UDP 
IP address: 
Network part 1 1 byte  [1,126], [128, 223] 
IP address: 
Network part 2 1 byte  [0, 255] 
IP address: 
Host part 1 1 byte  [0, 255] 
IP address: 
Host part 2 1 byte  [1, 254] 
...
This message contains the protocol to be expected from an auxiliary GNSS receiver connected to POS MV. The default NMEA setting directs POS MV to decode the Aux GNSS data as per the NMEA standard. The NAVCOM setting directs POS MV to decode the GGA station ID field according to the non-standard NAVCOM encoding. 
...
Item Bytes Format Value Units 
Aux GNSS 1 protocol 1 Byte Value Protocol 
0 NMEA (default) 
1 NAVCOM 
Aux GNSS 2 protocol 1 Byte Value Protocol 
0 NMEA (default) 
1 NAVCOM 
Pad 0 byte 0 N/A 
Checksum 2 ushort N/A N/A 
...
Item Bytes Format Value Units 
DGPS source mode 1 byte Source mode for DGPS corrections: 
0 Disabled 
2 MarineStar VBS only 
5          MarineStar XP only 
6          MarineStar HP only 
7          MarineStar Auto mode 
1, 3, 4  Reserved 
8-11 Reserved 
12        MarineStar G2 only 
13        MarineStar HPXP 
14        MarineStar HPG2 N/A 
Beacon Acquisition Mode 1 byte Beacon mode used to acquire DGPS signals : 
0 Channel disabled 
1 Manual mode 
...
Satellite ID 1 byte 0-8    Reserved 
9    MarineStar Auto ID Search 
10-255   Reserved N/A 
Satellite bit rate 2 ushort [600, 1200, 2400] baud 
Satellite frequency 8 double [1500e6-1600e6] Hz 
Request Database Source 1 byte 0 Unknown 
1 Beacon Stations 
2 LandStar Stations 
3-255 Reserved N/A 

Item Bytes Format Value Units 
Landstar Correction Source 1 byte 0 Unknown 
1 LandStar Stations 
2 LandStar Network 
3-255 Reserved N/A 
MarineSTAR Activation Code 25 byte 0  Unknown 
(0,) Enter service Provider Activation Information N/A 
DGPS source mode 2 1 byte Source mode for DGPS corrections: 
0 Disabled 
8          WAAS mode 
9          EGNOS mode 
10        MSAS mode 
...
This message directs POS MV to output specified groups on the Display Port primarily for the purpose of display of data on the POS Controller. 
The Number of Groups field contains the number n of groups that this message selects. Thereafter follow n Display Port Output Group Identification fields, each of which identifies one selected group to be output on the Display Port. 
...
This message directs POS MV to output specified groups on the Real-Time Data Port at a specified rate. 
The Number of Groups field contains the number n of groups that this message selects. Thereafter follow n Data Port Output Group Identification fields, each of which identifies one selected group to be output on the Data Port. 
...
The selected UDP unicast address must be on the currently set POS subnet or the message will be rejected. See subnet mask description for Message 32 on page 66 for more details. 
POS MV accepts this message at anytime. The parameters contained in this message become part of the processing parameters (referred to as "settings") that POS MV saves to NVM. 
Table 61: Message 52 Real-Time/Logging Data Port Control 
Item Bytes Format Value Units 
Message start 4 char $MSG N/A 
Message ID 2 ushort 52 N/A 
Byte count 2 ushort 15 + 2 x number of groups 
(+1 or 3 pad bytes) N/A 
Transaction number 2 ushort Input: Transaction number 
Output: [65533, 65535] N/A 
...
Data Port Protocol 1 byte Value 
0 
1 
2 Protocol 
TCP (default) 
...
UDP Unicast 
IP Address: 
Network part 1 1 byte  
[128, 191] Class B, subnet mask  255.255.0.0 
[192, 232] Class C, subnet mask  255.255.255.0 
default = 192 N/A 

Item Bytes Format Value Units 
UDP Unicast 
IP Address: 
Network part 2 1 byte  [0, 255] default = 168 N/A 
UDP Unicast 
IP Address: 
Host part 1 1 byte  [0, 255] default = 53 N/A 
UDP Unicast 
IP Address: 
Host part 2 1 byte  [1, 253] default = 1 N/A 
Pad 1 or 3 byte 0 N/A 
Checksum 2 ushort N/A N/A 
Message end 2 char $# N/A 

Message 53: Logging Port Control 
This message controls a data-logging device and directs the POS MV to output specified groups on the Logging Port at a specified rate. 
The Number of Groups field contains the number n of groups that this message selects. Thereafter follow n Logging Port Output Group Identification fields, each of which identifies one selected group to be output on the Logging Port. 
...
Byte count 2 ushort 76 + 2 x number of groups 
(+2 if required for pad) N/A 
Transaction number 2 ushort Input: Transaction number 
Output: [65533, 65535] N/A 
Number of groups selected for Logging Port  2 ushort  [0, 70] default = 0 N/A 
Logging Port output group identification variable ushort Group ID to Output 
[1, 65534] N/A 
Logging Port output group identification 2 ushort Group ID to Output 
[1, 65534] N/A 
Logging Port output rate 2 ushort Value  Rate (Hz)   
1  1  (default) 
2  2  
10  10  
20  20  
...
50  50  
100  100  
200  200 (NOT available for IMU type 17.) 
other values reserved 
Select/deselect 
AutoLog 1 byte Value  State    
0  AutoLog disabled (default) 
1  AutoLog enabled 
2-255  No action 

Item Bytes Format Value Units 
Disk logging control 1 byte Value  Command   
0  Stop logging  (default) 
1  Start logging 
2-255  No action 
...
POS MV accepts this message at any time. It will only use the data in this message if GPS data remains unavailable for longer than 120 seconds after receipt of this message. It will supersede this general data with GPS position data as soon as the GPS data becomes available. POS MV does not save this message to NVM, hence the user must provide this message during every POS MV start-up where the general data are required. 
...
The calibration is done assuming that the IMU Frame is the Reference Frame. If it is desirable to have the IMU and Reference Frames non-coincident, then the user must apply additional offsets consistently to all sensor frames to define a non-coincident Reference Frame. 
...
The user selects one or more installation parameter sets for calibration by setting the bits in the calibration select byte corresponding to the parameter sets to be calibrated to 1. The user starts a calibration of the selected installation parameters by setting the calibration action byte to 2 for a manual calibration or 3 for an auto-calibration. POS MV restarts the Navigate mode with the calibration option set. It then computes corrected versions of the selected installation parameters and reports these with corresponding calibration figures of merit (FOM) in Group 14: Calibrated installation parameters. A calibration of a selected set of installation parameters is completed when the corresponding FOM reaches 100. 
The user stops all calibrations by setting the calibration action byte to 1. POS MV restarts the Navigate mode without the calibration option and abandons any previous calibration actions. 
In an auto-calibration, POS MV replaces the existing set of installation parameters and issues a corresponding Message 20: General Installation and Processing Parameters or Message 22: Aiding Sensor Installation Parameters when the calibration is completed. POS MV resets its Kalman filter and restarts the normal Navigate mode with the updated installation parameters when all selected calibrations are completed. 
In a manual calibration, POS MV continues the calibration and displays the final values in Group 14: Calibrated installation parameters until it receives a user command to stop the calibration or transfer the calibrated parameters. 
...
6-255 No action 
Calibration select 2 ushort Bit (set) Command 
0 Calibrate primary GPS lever arm 
1 Calibrate auxiliary 1 GPS lever arm 
2 Calibrate auxiliary 2 GPS lever arm 
3 - 7 reserved 
8 Calibrate GAMS lever arm 
Pad 0 byte 0 N/A 
Checksum 2 ushort N/A N/A 
Message end 2 char $# N/A 

Message 58: GAMS Calibration Control 
This message controls the operation of the GAMS calibration function. POS MV accepts this message at any time. 
...
. force a calibration to start without regard to the current navigation solution attitude accuracy (deprecated) 
...
0 Stop calibration (default) (deprecated) 
1 Begin or resume calibration 
2 Suspend calibration (deprecated) 
3 Force calibration (deprecated) 
4-255 No action 
Pad 1 byte 0 N/A 
Checksum 2 ushort N/A N/A 
Message end 2 char $# N/A 
...
POS MV accepts this message at anytime. The parameters contained in this message become part of the processing parameters (referred to as "settings") that POS MV saves to NVM. 
Table 68: Message 61: Second Data Port Control 
Item Bytes Format Value Units 
Message start 4 char $MSG N/A 
...
This message controls the operational status of POS MV. POS MV accepts this message at any time. 
...
The message is accepted anytime, but is redundant if "Login" (Password Control) is sent when "user logged in" condition exists (see Table 31: Group 110: MV General Status & FDIR). This is the case when the user has logged in within the last 10 minutes, and has not disconnected or terminated the connection to the PCS, since the login. 
The message is not saved to NVM, when sent (and accepted) with Password Control equal to "Change Password". The new password is, however, immediately saved in the operating system's configuration file. The message is not echoed nor output to any of Display or Data Ports. 
...
0 Login 
1 Change Password N/A 
Password 20 char String value of current Password, terminated by "null" if less than 20 characters, or 20 (non-null) characters. 
Default: pcsPasswd N/A 
New Password 20 char If Password Control =  0: N/A 
If Password Control =  1: String value of new (user-selected) Password, terminated by "null" if less than 20 characters, or 20 (non-null) characters. N/A 
Pad 1 byte 0 N/A 
Checksum 2 ushort N/A N/A 
Message end 2 char $# N/A 

Message 120: Sensor Parameter Set-up 
This message contains data that is sent to POS to define the installation parameters of sensors 1 and 2 and the heave lever arm. 
...
The lever arm distances are measured from the user defined reference frame origin to vessel position of interest resolved in the reference frame. 
...
The ZDA, UTC and PPS output strings are fixed at 1 Hz (if selected) and synchronized to the GPS PPS. They may be combined with other outputs at higher rates. 
Table 75: Message 135: NMEA Output Set-up 
Item Bytes Format Value Units 
Message start 4 char $MSG N/A 
Message ID 2 ushort 135 N/A 
Byte count 2 ushort For even #ports (16 + #ports x 10) 
For odd #ports (18 + #ports x 10) N/A 
Transaction # 2 ushort Input: Transaction number set by client 
Output: [65533, 65535] N/A 
...
0 $xxGST NMEA (pseudorange measurement noise stats) 
1 (default) $xxGGA NMEA (Global Position System Fix) 
2 $xxHDT NMEA (heading) 
3 $xxZDA NMEA (date & time) 
4,5 reserved 
6 $xxVTG NMEA (track and speed) 
7 $PASHR NMEA (attitude (Tate-Bryant)) 
8 $PASHR NMEA (attitude (TSS)) 
9 $PRDID NMEA (attitude (Tate-Bryant) 
10 $PRDID NMEA (attitude (TSS) 
11 $xxGGK NMEA (Global Position System Fix) 
12 $UTC UTC date and time 
13 reserved 
14 $xxPPS UTC time of PPS pulse 
15 reserved 
16 $xxRMC NMEA (Global Position System Fix) 
21 $xxGLL NMEA (Global Position System Fix) 
22 UTCT    UTC Time Trimble Format 
23 $xxGGAT NMEA (Trimble expanded GGA) 
xx - is substituted by the Talker ID N/A 
Nmea output rate 2 ushort Value Rate (Hz) 
0 N/A Hz 
1 1 (default) 
2 2 
5 5 
...
202          0.05 
Note:  
0.1, 0.05Hz not applicable to ZDA, UTC, PPS 
...
This message allows the user to configure the real-time binary output on one or more COM ports.  The COM ports on which the binary output appears is controlled by message 34. 
...
Byte count 2 ushort For even #ports (16 + #ports x 10) 
For odd #ports (14 + #ports x 10) N/A 
...
0 - 2 reserved 
3 Simrad1000 header (Tate-Bryant) roll = . pitch = . heave = heave heading = . 
4 Simrad1000 header (TSS) roll = sin-1(sin.cos.) pitch = . heave = heave heading = . 
5 Simrad3000 header (Tate-Bryant) roll = . pitch =  . heave = heave heading = . 
6 Simrad3000 header (TSS) roll = sin-1(sin.cos.) pitch = . heave = heave N/A 
heading = . 
7 TSS (Format 1) header (default) horizontal acceleration vertical acceleration heave = heave status roll = sin-1(sin.cos.) pitch = . <CR><LF> 
8 TSM 5265 header (Tate-Bryant) time tag roll = . pitch =  . heave = heave heading = . vel (long, trans, down) 
9 TSM 5265 time tag (TSS) roll = sin-1(sin.cos.) pitch = . heave = heave heading = . vel (long, trans, down) 
10 Atlas header (TSS) roll = sin-1(sin.cos.) pitch = . heave = heave status footer 
11 - 15 reserved 
16 PPS header GPS seconds of week week number UTC offset PPS count checksum 
17 TM1B header checksum byte count week number 
GPS seconds of week clock offset clock offset std. dev. UTC offset clock model status 
Message Update Rate 1 byte Value Rate (Hz) 
0 N/A 
1 1 
2 2 
5 5 
...
0 Disabled (default) Output navigation solution data 
1 Enabled Output operator specified fixed values  
Pad 1 byte 0 N/A 
Checksum 2 ushort N/A N/A 
Message end 2 char $# N/A 
...
Table 82: Long Integer Format 
MSB LSB 
31                             24 23                             16 15                               8 7                                  0 

Byte #:  3   2   1   0 
Float and Double 
The floating point format of the POS data is the INTEL byte order from the IEEE-754 floating point representation standard as follows: 
Table 83: Single-Precision Real Format 
Single-Precision Data format 31 30                   23 22                                                      0  s e f      
Field Size in Bits 
Sign (s) 1 
...
Double-Precision Data format 63 62                        52 51                                                      0  s e f      
Field Size in Bits 
Sign (s) 1 
